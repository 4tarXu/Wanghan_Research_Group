function [TotalCost,FitnV]=Fitness(Distance,Demand,Chrom,Capacity,Travelcon,VehicleNum,VehicleCost,BatteryCap,ChargeStations_index)
%% 计算各个体的路径长度 适应度函数  
% 输入：
% Distance      两两城市之间的距离
% Demand        各点需求量
...
for i=1:NIND
    ...
    TotalCost(i)=Dis + VehicleNum(i) * VehicleCost;%存储此方案总距离
end
