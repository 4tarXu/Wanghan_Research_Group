...
save('Solution/instance.mat','Cus_select','Task_Cus','Cus','Task')
...
print(figure(1),'-djpeg',['Solution\',filename1])
print(figure(2),'-djpeg',['Solution\',filename2])
...
%   保存所有输出变量
save(['Solution/',num2str(Run_test),'.mat'],'Best_route','Best_route_mode','Best_solution','Ave_solution','Time_iter','Time_Cost','Best_iter')
