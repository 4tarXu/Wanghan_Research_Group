function Chrom = RemoveRedundantChargers(Distance,Demand,Chrom,Capacity,Travelcon,VehicleNum,VehicleCost,BatteryCap,ChargeStations_index,ChargeStationNum)
% 剔除子路径中多余的充电站：
